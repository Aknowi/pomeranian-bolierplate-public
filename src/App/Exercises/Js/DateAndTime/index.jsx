...
export const DateAndTime = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      const weekendTimestamp = new Date('2023-08-04 21:00:00').getTime();
  ...
  return (
    <div>
      ...
      <p>
        Countdown to Weekend: {daysToWeekend} days {hoursToWeekend} hours{' '}
        {minutesToWeekend} minutes and {secondsToWeekend} seconds
      </p>
    </div>
  );
};
