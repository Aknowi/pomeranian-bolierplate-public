...
export const TryCatchThis = () => {
  ...
  try {
    ...
    console.log(error.message, 'Wystąpił błąd dla proby dzielenia przez zero');
  }
  ...
  const validate = (value) => {
    if (!Number.isInteger(+value)) {
      throw new Error('Wprowadz poprawna liczbe');
    }
  };
  ...
  return (
    <div>
      <input onChange={handleOnChange} type="number"></input>
      <div>{error}</div>
    </div>
  );
};
